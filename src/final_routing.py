            ...
            rows.append(
                {
                    ...
                    "territory_weekday_index": client.get("territory_weekday_index"),
                    "territory_weekday": client.get("territory_weekday"),
                    "global_territory_cluster_id": client.get("global_territory_cluster_id"),
                    "global_territory_weekday_index": client.get("global_territory_weekday_index"),
                    "global_territory_weekday": client.get("global_territory_weekday"),
